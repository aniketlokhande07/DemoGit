...
public struct ANLoader {
    ...
    fileprivate static var activityHeight = (UIScreen.screenWidth / widthDivision) / 3
    ...
    fileprivate class LoadingResource: UIView {
        ...
        fileprivate func addTextLabel(_ yPosition: CGFloat, text: String){
            textLabel = UILabel(frame: CGRect(x: 5, y: yPosition - 20, width: activityWidth - 10, height: 40))
